...
test('sanjay Accept: Normal alert', async ({ page }) => {
  ...
  test('sanity Dismiss: Confirmation alert', async ({ page }) => {
    await page.goto("https://testpages.herokuapp.com/styled/alerts/alert-test.html");
  ...
  test('sanity Accept: Prompt alert', async ({ page }) => {
    await page.goto("https://testpages.herokuapp.com/styled/alerts/alert-test.html");
  ...
  test('sanity Model Popup', async ({ page }) => {
